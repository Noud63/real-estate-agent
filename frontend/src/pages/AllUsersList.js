        ...
        <div className="allUsersContainer">
            ...
            {allUsers && allUsers.map(user => {
                ...
                return <div key={_id} className="userInfo">
                    <AllUsersInfo allUsers={allUsers} isSuccess={isSuccess} address={address} city={city} country={country} email={email} firstname={firstname} lastname={lastname} number={number} telephone={telephone} username={username} zip={zip} id={_id}/>
                </div>
            })}
        </div>
    )
